 ...
 */
public class Demo03FileFilterInnerClass {
    ...
    public static void getAllFiles(File dir){
        ...
        File[] files = dir.listFiles(
                pathname -> pathname.isDirectory() || pathname.getName().toLowerCase().endsWith("docx")
        );
         */
        ...
        // 使用 lambda 表达式
        File[] files = dir.listFiles(
                (File d, String name) -> new File(d,name).isDirectory() || name.toLowerCase().endsWith("docx")
        );
